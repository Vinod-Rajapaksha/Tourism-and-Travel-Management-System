...
import com.example.ttms.dto.LoginRequestDTO;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequestDTO login) {
        ...
        return ResponseEntity.ok(Map.of("token", token, "email", admin.getEmail(), "role", admin.getRole(), "fName", admin.getFName(), "lName", admin.getLName()));
    }
    ...
    public ResponseEntity<?> me(Authentication authentication) {
        ...
        return ResponseEntity.ok(Map.of(
                ...
                "fName", admin.getFName(),  // ✅ Fix: Real first name
